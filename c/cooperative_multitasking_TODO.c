...
In cooperative multitasking, your main loop will look like this: 

```c
void loop()
{
    // these tasks must *never* block! They use state machines and time stamps to control their
    // execution, and run and exit immediately, seemingly "in parallel".
